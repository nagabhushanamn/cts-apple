  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__findById__reviews
        ...
        "prototype$__findById__reviews": {
          ...
          url: urlBase + "/products/:id/reviews/:fk",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__destroyById__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__updateById__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__get__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
        ...
        "prototype$__get__reviews": {
          isArray: true,
          url: urlBase + "/products/:id/reviews",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__create__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__delete__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Product#prototype$__count__reviews
         * @methodOf lbServices.Product
         *
         * @description
         *
         * Counts reviews of Product.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        "prototype$__count__reviews": {
          url: urlBase + "/products/:id/reviews/count",
          method: "GET"
        },
